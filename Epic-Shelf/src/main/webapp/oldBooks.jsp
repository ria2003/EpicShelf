...
<body>
	...
	<div class="container" style="margin-bottom:50px;">
		...
		<div class="row g-5">
			...
			List<Books> list1 = dao1.getAllOldBook();
			for (Books b : list1) {
			%>
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="book1" src="uploads/<%=b.getCover()%>"
							style="width: 150px; height: 200px; border-radius:5px" class="img-thumblin">
						...
						<%
							if (u == null) {
							%>
							<a href="login.jsp" class="btn btn-danger btn-sm ml-2" style="width: 60px"><i
